...
class DetailedMatchDataView: BaseView {
    ...
    private let startDataStackView: UIStackView = UIStackView()
    private let startDateLabel: UILabel = UILabel()
    private let startTimeLabel: UILabel = UILabel()
    
    private let matchDetailsStackView: UIStackView = UIStackView()
    
    private let matchScoreStackView: UIStackView = UIStackView()
    ...
    private let matchTimeLabel: UILabel = UILabel()
    ...
    func set(match: Event) {
        ...
        homeScoreLabel.text = match.homeScore != nil ? match.homeScore?.toString() : ""
        awayScoreLabel.text = match.awayScore != nil ? match.awayScore?.toString() : ""
